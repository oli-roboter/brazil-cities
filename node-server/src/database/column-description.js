const source =
  "https://www.kaggle.com/crisparada/brazilian-cities#Data_Dictionary.csv";
...
export const headers = {
  ...
  IBGE_1_4: "Resident Population Regular Urban Planning - from 1 to 4 y.o",
  IBGE_5_9: "Resident Population Regular Urban Planning - from 4 to 9 y.o",
  IBGE_10_1: "4Resident Population Regular Urban Planning - from 10 to 14 y.o",
  IBGE_15_59: "Resident Population Regular Urban Planning - from 15 to 59 y.o",
  IBGE_60_PLUS: "Resident Population Regular Urban Planning - above 60 y.o",
  IBGE_PLANTED_AREA: "Planted Area (hectares)",
  IBGE_CROP_PRODUCTION_$: "Crop Production",
  IDHM_Ranking: "2010HDI Ranking",
  IDHMH: "Human Development Index",
